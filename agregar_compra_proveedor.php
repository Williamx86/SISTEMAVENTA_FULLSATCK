...
<body>
        ...
        <div class="container">
            <div class="row justify-content-around">
                <div class="col-11 pt-5">
                    <div class="panel_inicio">
                        <div class="texto_inicio">
                            <h3>Agregar compra de proveedor</h3>
                        </div>
                    </div>
                ...
                <div class="col-11 pt-4">
                    <form action="backend/c_compra_proveedor.php" method="POST" >

                        <div class="formulario_compras pb-4">
                            <div class="entradas-formulario_compra">
                                <div class="info_desplegable">
                                    <img src="img/info.svg" tabindex="0" data-bs-toggle="popover" data-bs-placement="left" data-bs-trigger="hover focus" title="Número" data-bs-content="Es el número de factura, credito fiscal o quedan. Si no existe, colocar el valor  “0”.">
                            ...
                            <div class="entradas-formulario_compra_chec">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" name="tipo_pago" id="inlineCheckbox1" value="caja">
                                    <label class="form-check-label" for="inlineCheckbox1">Pago con caja</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" name="tipo_pago" id="inlineCheckbox2" value="cheque" data-bs-toggle="modal" data-bs-target="#Cheque">
                                    <label class="form-check-label" for="inlineCheckbox2">Pago con cheque</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" name="tipo_pago" id="inlineCheckbox2" value="otro">
                                    <label class="form-check-label" for="inlineCheckbox2">Pago otro</label>
                                </div>
                            </div>
                        </div>

                        <div class="botones_principales_menus py-3">
                            <a class="shadow" href="#" data-bs-toggle="modal" data-bs-target="#Lacteos">
                        ...
                        <div class="formulario_compras py-3">
                            <div class="entradas-formulario_compra">
                                ...
                                <input id="total_pintar" type="number" name="total" step="0.01" readonly>
                            </div>
                        </div>

                        <div class="botones_formulario pt-4 pb-4">
                            <a class="shadow" href="compras.php">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="acciones_botones">
                                                    <a class="btn_accion_azul btn_modificado" onclick="agregar_producto('<?php echo $mostrar['nombre'] ?>','<?php echo $mostrar['sku'] ?>',<?php echo $identificador_unidad ?>,<?php echo $identificador_precio ?>)" href="#">
                                            ...
                                            <td class="cantidad_producto_mod">
                                                <input id="<?php echo $identificador_precio ?>" type="number" step="0.01" value="0.00">
                                            </td>
                                        </tr>
    ...
    <!-- Modal Cheque -->
    <div class="modal fade" id="Cheque" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-md modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="exampleModalLabel">Pago con cheque</h4>
                            ...
                            <div class="col-10">
                                <form action="#" class="formulario_general">
                                    <div class="agregar_dinero py-4">
                                        <h5>Número</h5>
                                        <input id="password_usuario_admin" type="text">
                                    </div>

                                    <div class="botones_formulario pt-4 pb-4">
                                        <a class="shadow" href="#" data-bs-dismiss="modal" onclick="desmarcar()">
                                            <img src="img/cancelar.svg" alt="">
                                            <span>Cancelar</span>
                                        </a>
