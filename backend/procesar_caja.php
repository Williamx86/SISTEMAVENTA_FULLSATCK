<?php
    ...
    $b_cien = $_POST['b_cien'];
    $b_cincuenta = $_POST['b_cincuenta'];
    $b_veinte = $_POST['b_veinte'];
    $b_diez = $_POST['b_diez'];
    $b_cinco = $_POST['b_cinco'];
    $b_uno = $_POST['b_uno'];
    $m_cora = $_POST['m_cora'];
    $m_diez = $_POST['m_diez'];
    $m_cinco = $_POST['m_cinco'];
    $m_uno = $_POST['m_uno'];
    $total_registrado = $_POST['total_registrado'];
    ...
    $insertar_venta = "INSERT INTO caja 
    (b_cien, b_cincuenta , b_veinte, b_diez, b_cinco, b_uno, m_cora, m_diez, m_cinco, m_uno, total_registrado, efectivo, tarjeta, bitcoin, remesa, compra, total_final, fecha, cajero) 
    VALUES 
    ('$b_cien','$b_cincuenta','$b_veinte','$b_diez','$b_cinco','$b_uno','$m_cora','$m_diez','$m_cinco','$m_uno','$total_registrado','$efectivo','$tarjeta','$bitcoin','$remesa','$compra','$total_final','$fecha','$cajero')";
