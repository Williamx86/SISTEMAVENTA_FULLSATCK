...
<body>
                            ...
                            <tr>
                                <td>
                                    <div class="acciones_botones">
                                        ...
                                        <a class="btn_accion_rojo" href="backend/d_bodega_lacteos.php?id=<?php echo $mostrar['id'] ?>">
        ...
        <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="exampleModalLabel">Bodega - Lacteos - Agregar producto</h4>
                ...
                <div class="modal-body">
                    <div class="container">
                        <div class="row justify-content-around">
                            <div class="col-11">
                                <form action="backend/c_bodega_lacteos.php" method="POST" class="formulario_general">
    ...
    <div class="modal fade" id="Editarproducto" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="exampleModalLabel">Bodega - Lacteos - Editar producto</h4>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="container">
                        <div class="row justify-content-around">
                            <div class="col-11">
                                <form action="backend/u_bodega_lacteos.php" method="POST" class="formulario_general">
                                    <div class="entrada pt-5">
                                        <div>
                                            <label class="mb-2">SKU:</label>
                                    ...
                                    <div class="entrada_mod pt-5 pb-5">
                                        ...
                                        <div>
                                            <label class="mb-2">Stock:</label>
                                            <input class="input_modificado editar_bodega_lacteos_stock" type="number" step="0.01" name="stock_editar">
                                        </div>
