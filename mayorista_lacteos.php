                ...
                <div class="col-11 pt-5">
                    <div class="panel_inicio">
                        <div class="texto_inicio">
                            <h3>Precios - Mayorista - Lacteos</h3>
                        </div>
                    </div>
        ...
        <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="exampleModalLabel">Agregar precio - Mayorista - Lacteos</h4>
                ...
                <div class="modal-body">
                    <div class="container">
                        <div class="row justify-content-around">
                            <div class="col-11">
                                <form action="backend/u_mayorista_lacteos.php" method="POST" class="formulario_general">
