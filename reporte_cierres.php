            ...
            <div class="row justify-content-around">
                <div class="col-11 pt-5">
                    <div class="panel_inicio">
                        <div class="texto_inicio">
                            <h3>Historial de cierre de caja</h3>
                        </div>
                    </div>
                ...
                <div class="col-11 py-5">
                    <table id="dt" class="display" style="width:100%">
                        ...
                        <?php
                            $consulta = "SELECT * FROM caja order by id desc";
                            ...
                            <tr>
                                <td>
                                    <div class="acciones_botones">
                                        <a class="btn_accion_rojo" href="backend/d_cierre.php?id=<?php echo $mostrar['id'] ?>">
                                            <img src="img/basurero.svg">
                                        </a> 
                                        <a class="btn_accion_azul" href="backend/ticket_cierre.php?id=<?php echo $mostrar['id'] ?>">
                                ...
                                <td>
                                    <?php echo $mostrar['cajero'] ?>
                                </td>
                                <td>
                                    <?php if($mostrar['total_registrado'] == $mostrar['total_final']){echo "✔️";}else{echo "❌";} ?>
                                </td>
                            </tr>
