        ...
        <div class="container">
            <div class="row justify-content-around">
                <div class="col-11 pt-5">
                    <div class="panel_inicio">
                        ...
                        <div class="selectores_inicio">
                            ...
                            <a href="panel_ayer.php">Ayer</a>
                            <a href="panel_all.php" class="selectores_inicio_activo">Últimos 30 días</a>
                        </div>
                    </div>
                ...
                <?php
                    ...
                    $consulta_dos = "SELECT SUM(total) AS total_ventas FROM ventas WHERE fecha BETWEEN DATE_SUB(NOW(), INTERVAL 30 DAY) AND NOW() ";
                ...
                <?php
                    $ventas = array();
                    $consulta_media = "SELECT * FROM ventas WHERE fecha BETWEEN DATE_SUB(NOW(), INTERVAL 30 DAY) AND NOW()";
...
bodega</span>
                ...
                <div class="col-11 py-5">
                    <table id="dt" class="display" style="width:100%">
                        ...
                        <?php
                            $consulta = "SELECT * FROM ventas WHERE fecha BETWEEN DATE_SUB(NOW(), INTERVAL 30 DAY) AND NOW() order by id desc";
    ...
    <script>
        ...
        var url = 'consultapanel_treinta.php';
        fetch(url)
            .then(res => res.json())
            .then(datos => {
                var urlcorr = 'consultacorr_treinta.php';
                fetch(urlcorr)
                    .then(resp => resp.json())
                    .then(corr => {
