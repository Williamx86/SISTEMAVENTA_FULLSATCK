            ...
            <form id="productosform" action="backend/procesar_venta.php" method="POST">
                <table>
                    ...
                    <div>
                        ...
                        <input type="hidden" name="cliente" value="Mayorista">
                    </div>
                </table>
            </form>
        </div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="acciones_botones">
                                                    <a class="btn_accion_azul btn_modificado" onclick="agregar_producto('<?php echo $mostrar['nombre'] ?>',<?php echo $mostrar['precio_mayorista'] ?>,<?php echo $identificador_unidad ?>)" href="#">
