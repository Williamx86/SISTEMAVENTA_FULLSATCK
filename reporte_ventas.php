            ...
            <div class="row justify-content-around">
                ...
                <div class="col-11 py-5">
                    <table id="dt" class="display" style="width:100%">
                        ...
                        <?php
                            $consulta_envios = "SELECT * FROM envio_info order by id desc";
                            $resultado_envios =  mysqli_query($conexion,$consulta_envios);

                            while($mostrar = mysqli_fetch_array($resultado_envios)){
                        ?> 

                            <tr>
                                <td>
                                    <div class="acciones_botones"> 
                                        <a class="btn_accion_rojo" href="backend/d_envio.php?id=<?php echo $mostrar['id'] ?>">
                                            <img src="img/basurero.svg">
                                        </a>   
                                        <a class="btn_accion_azul" href="backend/ticket_envio.php?id=<?php echo $mostrar['id'] ?>">
                        ...
                        <?php
                            $consulta = "SELECT * FROM ventas WHERE metodo = 'Bitcoin' OR metodo = 'Débito' OR metodo = 'Crédito' OR metodo = 'Efectivo' order by id desc";
                        ...
                        ?> 
                            ...
                            <tr>
                                <td>
                                    <div class="acciones_botones"> 
                                        <a class="btn_accion_rojo" href="backend/d_venta.php?id=<?php echo $mostrar['id'] ?>">
                                            <img src="img/basurero.svg">
                                        </a>   
