...
<body>
    ...
    <div class="ticket_venta">
        ...
        <div class="cuerpo_ticket ticket_largo">

            <form id="productosform" action="backend/procesar_envio.php" method="POST">
                <table>
                    <thead>
                        <tr>
                            <th>Unid.</th>
                    ...
                    <div>
                        ...
                        <input type="hidden" name="cliente" value="Sucursal">
                    </div>
                </table>
            </form>
        </div>
        <div class="final_ticket">
            ...
            <p style="display:none;">Cambio: $ <span id="cambio_pantalla"></span> </p>
        </div>
    </div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="acciones_botones">
                                                    <a class="btn_accion_azul btn_modificado" onclick="agregar_producto('<?php echo $mostrar['nombre'] ?>',<?php echo $mostrar['precio_compra'] ?>,<?php echo $identificador_unidad ?>)" href="#">
                                            ...
                                            <td>
                                                <?php echo $mostrar['precio_compra'] ?>
                                            </td>
                                        </tr>
