                ...
                <div class="col-11 pt-5">
                    <div class="panel_inicio">
                        <div class="texto_inicio">
                            <h3>Precios - Mayorista - Abarrotes</h3>
                        </div>
                    </div>
                            ...
                            <tr>
                                <td>
                                    <div class="acciones_botones">
                                        <a class="btn_accion_amarillo" onclick="editar_bodega_sala('<?php echo $mostrar['sku'] ?>','<?php echo $mostrar['nombre'] ?>',<?php echo $mostrar['precio_mayorista'] ?>,<?php echo $mostrar['id'] ?>)" href="#" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                ...
                                <td>
                                    <?php echo $mostrar['precio_mayorista'] ?>
                                </td>
                            </tr>
        ...
        <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="exampleModalLabel">Agregar precio - Mayorista - Abarrotes</h4>
                ...
                <div class="modal-body">
                    <div class="container">
                        <div class="row justify-content-around">
                            <div class="col-11">
                                <form action="backend/u_mayorista_abarrotes.php" method="POST" class="formulario_general">
