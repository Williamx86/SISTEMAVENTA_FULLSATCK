            ...
            <div class="row justify-content-around">
                ...
                <div class="col-11 py-5">
                    <table id="dt" class="display" style="width:100%">
                        ...
                        <?php
                            $consulta = "SELECT * FROM proveedor order by id desc";
                            ...
                            <tr>
                                <td>
                                    <div class="acciones_botones"> 
                                        <a class="btn_accion_amarillo" onclick="editar_proveedor('<?php echo $mostrar['nrc'] ?>','<?php echo $mostrar['nombre'] ?>','<?php echo $mostrar['contacto'] ?>','<?php echo $mostrar['numero'] ?>',<?php echo $mostrar['id'] ?>)" href="#" data-bs-toggle="modal" data-bs-target="#Editarproveedor">
                                            <img src="img/lapiz.svg">
                                        </a>
                                        <a class="btn_accion_rojo" href="backend/d_proveedor.php?id=<?php echo $mostrar['id'] ?>">
                                ...
                                <td>
                                    <?php echo $mostrar['nrc'] ?>
                                </td>
                                <td>
                                    <?php echo $mostrar['contacto'] ?>
                                </td>
                                <td>
                                    <?php echo $mostrar['numero'] ?>
                                </td>
                            </tr>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="container">
                            <div class="row justify-content-around">
                                <div class="col-11">
                                    <form action="backend/c_proveedor_reportes.php" method="POST" class="formulario_general">
                                        <div class="entrada pt-5">
                                            <div>
                                                <label class="mb-2">NRC:</label>
                                                <input class="input_modificado input_modificado_sm" type="text" name="nrc" data-bs-toggle="popover" data-bs-trigger="focus" data-bs-placement="left" title="NRC" data-bs-content="Es el número de registro del contribuyente. Si no existe, colocar el valor  “0”.">
                                            </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="container">
                            <div class="row justify-content-around">
                                <div class="col-11">
                                    <form action="backend/u_proveedor.php" method="POST" class="formulario_general">
                                        <div class="entrada pt-5">
                                            <div>
                                                <label class="mb-2">NRC:</label>
                                                <input class="input_modificado input_modificado_sm" id="editar_nrc" type="text" name="nrc" data-bs-toggle="popover" data-bs-trigger="focus" data-bs-placement="left" title="NRC" data-bs-content="Es el número de registro del contribuyente. Si no existe, colocar el valor  “0”.">
                                                <input id="editar_id" type="hidden" name="id_editar">
                                            </div>
    
                                            <div>
                                                <label class="mb-2">Nombre de la empresa:</label>
                                                <input class="input_modificado input_modificado_xl" id="editar_nombre" type="text" name="nombre">
                                            </div>
                                        </div>
                                        ...
                                        <div class="entrada_mod pt-5 pb-5">
                                            <div>
                                                <label class="mb-2">Contacto de la empresa:</label>
                                                <input class="input_modificado input_modificado_sm" id="editar_contacto" type="text" name="contacto">
                                            </div>
    
                                            <div>
                                                <label class="mb-2">Número de contacto:</label>
                                                <input class="input_modificado" type="text" id="editar_numero" name="numero">
                                            </div>
                                        </div>
