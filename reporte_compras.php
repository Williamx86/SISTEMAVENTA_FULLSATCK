            ...
            <div class="row justify-content-around">
                ...
                <div class="col-11 py-5">
                    <table id="dt" class="display" style="width:100%">
                        ...
                        <?php
                            $consulta = "SELECT * FROM compras order by id desc";
                            ...
                            <tr>
                                <td>
                                    <div class="acciones_botones">
                                        <a class="btn_accion_rojo" href="backend/d_compra.php?id=<?php echo $mostrar['id'] ?>">
                                            <img src="img/basurero.svg">
                                        </a>   
                                        <a class="btn_accion_azul" href="r_compra.php?id=<?php echo $mostrar['id'] ?>">
