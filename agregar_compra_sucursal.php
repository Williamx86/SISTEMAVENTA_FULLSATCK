        ...
        <div class="container">
            <div class="row justify-content-around">
                ...
                <div class="col-11 pt-4">
                    <form action="backend/c_compra_sucursal.php" method="POST" >

                        <div class="formulario_compras pb-4">
                            <div class="entradas-formulario_compra">
                                <div class="info_desplegable">
                                    <img src="img/info.svg" tabindex="0" data-bs-toggle="popover" data-bs-placement="left" data-bs-trigger="hover focus" title="Número" data-bs-content="Es el número de ticket. Si no existe, colocar el valor  “0”.">
                                    <label>Número de comprobante:</label>
                                </div>
                                <input type="text" name="numero">
                            </div>
                            <div class="entradas-formulario_compra">
                                <label>Sucursal que proviene el producto:</label>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="acciones_botones">
                                                    <a class="btn_accion_azul btn_modificado" onclick="agregar_producto_sucursal('<?php echo $mostrar['nombre'] ?>','<?php echo $mostrar['sku'] ?>',<?php echo $identificador_unidad ?>)" href="#">
